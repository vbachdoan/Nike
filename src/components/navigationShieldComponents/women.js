                ...
                <div className="wrap-releases">
                    ...
                    <div className="wrap-child-block-navigation">
                        <div className="navigation-block">
                            ...
                            <Link to="/" className="navigation">Track & Field</Link>
                            ...
                            <Link to="/" className="navigation">Softball</Link>
                    ...
                    <div className="wrap-child-block-navigation">
                        <div className="navigation-block">
                            ...
                            <Link to="/" className="navigation">Sport Bras</Link>
                            ...
                            <Link to="/" className="navigation">Plus Size</Link>
                            <Link to="/" className="navigation">Yoga</Link>
                            <Link to="/" className="navigation">Skirts & Dresses</Link>
                            <Link to="/" className="navigation">Sustainable Materials</Link>
                            <Link to="/" className="navigation">Nike Maternity</Link>
