...
export default class MainNavigation extends React.Component{
    ...
    handleClick(){
        if(this.state.checkDisplay==="none"){
            this.setState({
            ...
            <>
                <div id="homepage-nav-main">
                    ...
                    <div id="link-right">
                        ...
                        <a style={{cursor:"pointer"}} onClick={this.handleClick}>Sign In</a>
                    </div>
                </div>
                <SignInPopUp checkDisplay={this.state.checkDisplay}/>
                {
                    this.state.checkDisplay==="display" &&
                    <div id="wrap-svg">
                        <svg id="x" fill="#111" height="24px" width="24px" viewBox="0 0 24 24"  onClick={this.handleDisappear}>
